...
//this code contain only the functional code no header files or main is inlcuded in it.
...
// One more way or another approach is 

// this code contain only the fuctional code no header files or main is included.
class Solution{
    public:
